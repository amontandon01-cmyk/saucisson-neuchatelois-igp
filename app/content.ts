...
export const ui = {
  fr: {
    ...
    proofTitle: "Simples à reconnaître. Difficiles à imiter.", proofText: "L’IGP protège un lieu de fabrication, un procédé et un goût. Chacune des deux spécialités réunit viande porcine suisse, gestes locaux et fumée maîtrisée.",
  ...
  de: {
    ...
    proofTitle: "Leicht zu erkennen. Schwer zu kopieren.", proofText: "Die IGP schützt Herstellungsort, Verfahren und Charakter. Schweizer Schweinefleisch, lokales Können und kontrollierter Rauch prägen beide Spezialitäten.",
...
const fr: Record<PageKey, DetailContent> = {
  ...
  association: {
    ...
    sections: [
      ...
      { kicker: "Clarté", title: "Trois listes, trois significations.", text: "Les membres ANMB appartiennent au réseau professionnel. Les fabricants IGP satisfont au cahier des charges et à la certification. Les points de vente sont des adresses où le public peut acheter le produit. Une même entreprise peut apparaître dans plusieurs listes, mais elles ne sont jamais équivalentes." },
    ],
  },
  members: {
    eyebrow: "Association · Réseau professionnel", title: "Les membres de l’ANMB.", intro: "L’annuaire de l’association rassemble les entreprises actives de la branche. Être membre de l’ANMB ne signifie pas automatiquement fabriquer un produit certifié IGP.",
    facts: [{ value: "21", label: "organisations actives publiées" }, { value: "7", label: "vétérans annoncés" }, { value: "4", label: "catégories statutaires" }, { value: "≠ IGP", label: "adhésion et certification" }],
    sections: [], note: "Liste regroupée par organisation à partir du site public de l’ANMB consulté le 4 septembre 2026. Les succursales ne sont pas comptées comme des membres distincts.",
  },
  committee: {
