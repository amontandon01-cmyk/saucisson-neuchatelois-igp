...
export const ui = {
  fr: {
    ...
    recipeTitle: "Trois façons de commencer", locatorTitle: "Des producteurs et points de vente validés.", locatorText: "La future carte n’affichera que les adresses confirmées par l’ANMB, avec filtres par région et type de point de vente.",
  ...
  de: {
    ...
    recipeTitle: "Drei Ideen für den Anfang", locatorTitle: "Geprüfte Produzenten und Verkaufsstellen.", locatorText: "Die künftige Karte zeigt nur von der ANMB bestätigte Adressen, filterbar nach Region und Verkaufsart.",
...
const fr: Record<PageKey, DetailContent> = {
  ...
  locator: {
    eyebrow: "Où acheter", title: "Le bon produit, à la bonne adresse.", intro: "Un annuaire unique remplacera les listes dispersées. Chaque fiche indiquera producteur, revendeur, horaires, services et itinéraire.",
    facts: [{ value: "4", label: "régions à filtrer" }, { value: "2", label: "types d’adresses" }, { value: "FR/DE", label: "recherche bilingue" }, { value: "ANMB", label: "données validées" }],
    sections: [
    ...
    ], note: "Aucune adresse fictive n’est publiée dans ce prototype ; l’ANMB validera l’annuaire avant diffusion.",
  },
  pro: {
...
const de: Record<PageKey, DetailContent> = {
  ...
  locator: { eyebrow: "Verkaufsstellen", title: "Das richtige Produkt an der richtigen Adresse.", intro: "Ein Verzeichnis ersetzt verstreute Listen und zeigt Produzent, Händler, Öffnungszeiten, Leistungen und Route.", facts: [{ value: "4", label: "Regionen" }, { value: "2", label: "Adressarten" }, { value: "FR/DE", label: "zweisprachig" }, { value: "ANMB", label: "geprüfte Daten" }], sections: [{ kicker: "Neuenburger Berge", title: "La Chaux-de-Fonds · Le Locle", text: "Teilnehmende Adressen erscheinen nach Freigabe der offiziellen Liste." }, { kicker: "Seeufer & Val-de-Ruz", title: "Neuchâtel · Boudry · Cernier", text: "Die Suche trennt IGP-Produzenten von Verkaufsstellen." }, { kicker: "Val-de-Travers & ausserkantonal", title: "Die IGP weiter weg finden.", text: "Partner in der Romandie und Deutschschweiz können später ergänzt werden." }], note: "Der Prototyp veröffentlicht keine erfundenen Adressen; die ANMB prüft die Liste." },
