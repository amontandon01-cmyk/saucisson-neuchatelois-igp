...
import { ArrowRight, Check, Clock3, ExternalLink, Flame, Network, ShieldCheck, ShoppingBag, Sparkles, Users, UtensilsCrossed } from "lucide-react";
...
function AssociationPage({ lang, pageKey }: { lang: Lang; pageKey: "association" | "committee" | "partners" }) {
  const page = pages[lang][pageKey];
  return <>
